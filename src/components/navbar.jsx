...
/>
            ...
            <div className="flex items-center ml-auto rounded-full bg-black border border-gray-300 h-8">
                ...
                <button type="button" className="p-2.5 text-gray-400 hover:text-gray-500">
                    ...
                    <svg className="h-5 w-5 text-white stroke-2" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true">
                ...
                <button type="button" className="p-2.5 text-gray-400 hover:text-gray-500">
                    <span className="sr-only">View notifications</span>
                    <svg className="w-5 h-5 text-white stroke-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
